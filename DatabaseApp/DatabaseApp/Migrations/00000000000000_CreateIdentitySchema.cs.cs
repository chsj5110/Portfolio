		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					Id = table.Column<int>(type: "int", nullable: false)
						.Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),  // Auto Increment 설정
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					LockoutEnd = table.Column<Timestamp>(type: "timestamp", nullable: true),
