...
namespace CdioCs
{
    unsafe public delegate int PINTCALLBACK(short Id, int wParam, int lParam, void* Param);
    unsafe public delegate int PTRGCALLBACK(short Id, int wParam, int lParam, void* Param);
    unsafe public delegate int PDMCOUNTCALLBACK(short Id, int wParam, int lParam, void* Param);
    unsafe public delegate int PDMSTOPCALLBACK(short Id, int wParam, int lParam, void* Param);
    ...
    public class Cdio
    {
        ...
        [DllImport("cdio.dll")]
        static extern int DioInpMultiByte(short Id, short[] PortNo, short PortNum, byte[] Data);
        [DllImport("cdio.dll")]
        static extern int DioInpMultiBit(short Id, short[] BitNo, short BitNum, byte[] Data);
        [DllImport("cdio.dll")]
        static extern int DioOutMultiByte(short Id, short[] PortNo, short PortNum, byte[] Data);
        [DllImport("cdio.dll")]
        static extern int DioOutMultiBit(short Id, short[] BitNo, short BitNum, byte[] Data);
        [DllImport("cdio.dll")]
        static extern int DioEchoBackMultiByte(short Id, short[] PortNo, short PortNum, byte[] Data);
        [DllImport("cdio.dll")]
        static extern int DioEchoBackMultiBit(short Id, short[] BitNo, short BitNum, byte[] Data);
