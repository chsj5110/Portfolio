...
namespace chsj
{
    public partial class FormW_1 : Form
    {
        ...
        private void FormW_1_Load(object sender, EventArgs e)
        {
            ...
            PF.LogWriter("FormW_1_Load", "FormW_1_Load");
        ...
        private void tb_w1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if(tb_w1.Text.Length > 8)
                {
                    ...
                    {
                        if(tb_w1.Text.Substring(tb_w1.Text.Length- PV.strLT6.Length-2, PV.strLT6.Length) == PV.strLT6)
                        {
                            PV.GetCode = tb_w1.Text;
                            PF.ScanLogWriter(tb_w1.Text, "박스 스캔", "", "", "", "", "", "", "BOX", "");
                            formwork.Box();
            ...
            {
                PF.LogWriter("tb_w1_TextChanged", ex.Message);
            }
